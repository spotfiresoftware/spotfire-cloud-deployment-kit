...
bootstrap_file=/opt/spotfire/spotfireserver/tomcat/webapps/spotfire/WEB-INF/bootstrap.xml
...
/opt/spotfire/spotfireserver/tomcat/spotfire-bin/config.sh bootstrap \
    --no-prompt \
