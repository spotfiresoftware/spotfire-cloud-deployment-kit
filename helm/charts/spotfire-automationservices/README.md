...
![Version: 2.2.1](https://img.shields.io/badge/Version-2.2.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.2-HF-009](https://img.shields.io/badge/AppVersion-14.6.2--HF--009-informational?style=flat-square)
...
| image.tag | string | `"14.6.2-HF-009-v4.2.1"` | The container image tag to use. |
