...
![Version: 2.2.4](https://img.shields.io/badge/Version-2.2.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.2-HF-012](https://img.shields.io/badge/AppVersion-14.6.2--HF--012-informational?style=flat-square)
...
| image.tag | string | `"14.6.2-HF-012-v4.2.4"` | The container image tag to use. |
