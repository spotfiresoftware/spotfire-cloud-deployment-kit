...
![Version: 2.2.2](https://img.shields.io/badge/Version-2.2.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.2-HF-010](https://img.shields.io/badge/AppVersion-14.6.2--HF--010-informational?style=flat-square)
...
| image.tag | string | `"14.6.2-HF-010-v4.2.2"` | The container image tag to use. |
