...
![Version: 4.0.3](https://img.shields.io/badge/Version-4.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.8.0-HF-003](https://img.shields.io/badge/AppVersion-14.8.0--HF--003-informational?style=flat-square)
...
| image.tag | string | `"14.8.0-HF-003-v6.0.3"` | The container image tag to use. |
