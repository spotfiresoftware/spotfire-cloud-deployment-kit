...
![Version: 4.0.2](https://img.shields.io/badge/Version-4.0.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.8.0-HF-002](https://img.shields.io/badge/AppVersion-14.8.0--HF--002-informational?style=flat-square)
...
| image.tag | string | `"14.8.0-HF-002-v6.0.2"` | The container image tag to use. |
