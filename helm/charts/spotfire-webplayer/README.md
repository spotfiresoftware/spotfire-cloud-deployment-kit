...
![Version: 2.3.2](https://img.shields.io/badge/Version-2.3.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.3-HF-015](https://img.shields.io/badge/AppVersion-14.6.3--HF--015-informational?style=flat-square)
...
| image.tag | string | `"14.6.3-HF-015-v4.3.2"` | The container image tag to use. |
