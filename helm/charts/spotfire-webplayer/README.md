...
![Version: 2.2.3](https://img.shields.io/badge/Version-2.2.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.2-HF-011](https://img.shields.io/badge/AppVersion-14.6.2--HF--011-informational?style=flat-square)
...
| image.tag | string | `"14.6.2-HF-011-v4.2.3"` | The container image tag to use. |
