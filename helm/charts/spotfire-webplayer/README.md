...
![Version: 3.0.1](https://img.shields.io/badge/Version-3.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.7.0-HF-001](https://img.shields.io/badge/AppVersion-14.7.0--HF--001-informational?style=flat-square)
...
| image.tag | string | `"14.7.0-HF-001-v5.0.1"` | The container image tag to use. |
