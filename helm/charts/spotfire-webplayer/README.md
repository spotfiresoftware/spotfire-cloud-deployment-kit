...
![Version: 2.1.4](https://img.shields.io/badge/Version-2.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.1-HF-007](https://img.shields.io/badge/AppVersion-14.6.1--HF--007-informational?style=flat-square)
...
| image.tag | string | `"14.6.1-HF-007-v4.1.4"` | The container image tag to use. |
