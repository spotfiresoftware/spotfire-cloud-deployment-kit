...
![Version: 2.3.3](https://img.shields.io/badge/Version-2.3.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.6.3](https://img.shields.io/badge/AppVersion-14.6.3-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-common | spotfire-common | 2.3.3 |
...
| cliPod.image.tag | string | `"14.6.3-v4.3.3"` | The spotfireConfig container image tag to use. |
...
| configJob.image.tag | string | `"14.6.3-v4.3.3"` | The spotfireConfig container image tag to use. |
...
| configuration.deployment.defaultDeployment.image.tag | string | `"14.6.3-HF-016-v4.3.3"` | The container image tag to use. |
...
| image.tag | string | `"14.6.3-v4.3.3"` | The container image tag to use. |
