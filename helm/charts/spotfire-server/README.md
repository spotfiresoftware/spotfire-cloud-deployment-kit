...
![Version: 4.0.1](https://img.shields.io/badge/Version-4.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.8.0](https://img.shields.io/badge/AppVersion-14.8.0-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-common | spotfire-common | 4.0.1 |
...
| cliPod.image.tag | string | `"14.8.0-v6.0.1"` | The spotfireConfig container image tag to use. |
...
| configJob.image.tag | string | `"14.8.0-v6.0.1"` | The spotfireConfig container image tag to use. |
...
| configuration.deployment.defaultDeployment.image.tag | string | `"14.8.0-HF-001-v6.0.1"` | The container image tag to use. |
...
| image.tag | string | `"14.8.0-v6.0.1"` | The container image tag to use. |
