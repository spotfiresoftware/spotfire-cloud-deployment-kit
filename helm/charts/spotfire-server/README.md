...
![Version: 0.3.0](https://img.shields.io/badge/Version-0.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.4.1](https://img.shields.io/badge/AppVersion-14.4.1-informational?style=flat-square)
...
| https://fluent.github.io/helm-charts | log-forwarder(fluent-bit) | 0.47.* |
| https://haproxytech.github.io/helm-charts | haproxy | 1.22.* |
...
| cliPod.image.tag | string | `"14.4.1-1"` | The spotfireConfig container image tag to use. |
...
| configJob.image.tag | string | `"14.4.1-1"` | The spotfireConfig container image tag to use. |
...
| configuration.deployment.defaultDeployment.image.tag | string | `"14.4.1-1"` | The container image tag to use. |
