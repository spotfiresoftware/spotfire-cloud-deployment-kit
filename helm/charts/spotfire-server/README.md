...
| image.tag | string | `"11.8.1-alpha3"` | The container image tag to be used. |
...
| spotfireConfig.image.tag | string | `"11.8.1-alpha3"` | The spotfireConfig container image tag to be used. |
