...
![Version: 0.2.4](https://img.shields.io/badge/Version-0.2.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.4.0](https://img.shields.io/badge/AppVersion-14.4.0-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-common | spotfire-common | 0.2.4 |
...
| cliPod.image.tag | string | `"14.4.0-1"` | The spotfireConfig container image tag to use. |
...
| configJob.image.tag | string | `"14.4.0-1"` | The spotfireConfig container image tag to use. |
...
| configuration.deployment.defaultDeployment.image.tag | string | `"14.4.0-1"` | The container image tag to use. |
...
| image.tag | string | `"14.4.0-1"` | The container image tag to use. |
