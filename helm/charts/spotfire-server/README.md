...
![Version: 3.0.3](https://img.shields.io/badge/Version-3.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.7.0](https://img.shields.io/badge/AppVersion-14.7.0-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-common | spotfire-common | 3.0.3 |
...
| cliPod.image.tag | string | `"14.7.0-v5.0.3"` | The spotfireConfig container image tag to use. |
...
| configJob.image.tag | string | `"14.7.0-v5.0.3"` | The spotfireConfig container image tag to use. |
...
| configuration.deployment.defaultDeployment.image.tag | string | `"14.7.0-HF-003-v5.0.3"` | The container image tag to use. |
...
| image.tag | string | `"14.7.0-v5.0.3"` | The container image tag to use. |
