...
![Version: 3.0.2](https://img.shields.io/badge/Version-3.0.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.7-v5.0.2](https://img.shields.io/badge/AppVersion-14.7--v5.0.2-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-automationservices/ | spotfire-automationservices | 3.0.2 |
| file://../spotfire-pythonservice/ | spotfire-pythonservice | 3.0.2 |
| file://../spotfire-rservice/ | spotfire-rservice | 3.0.2 |
| file://../spotfire-server/ | spotfire-server | 3.0.2 |
| file://../spotfire-terrservice/ | spotfire-terrservice | 3.0.2 |
| file://../spotfire-webplayer/ | spotfire-webplayer | 3.0.2 |
...
| spotfire-automationservices.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-automationservices.image.tag | string | `"14.7.0-HF-002-v5.0.2"` | The container image tag to use. |
...
| spotfire-pythonservice.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-pythonservice.image.tag | string | `"1.24.0-v5.0.2"` | The container image tag to use. |
...
| spotfire-rservice.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-rservice.image.tag | string | `"1.24.0-v5.0.2"` | The container image tag to use. |
...
| spotfire-server.cliPod.image.tag | string | `"14.7.0-v5.0.2"` | The spotfireConfig container image tag to use. |
...
| spotfire-server.configJob.image.tag | string | `"14.7.0-v5.0.2"` | The spotfireConfig container image tag to use. |
...
| spotfire-server.configuration.deployment.defaultDeployment.image.tag | string | `"14.7.0-HF-002-v5.0.2"` | The container image tag to use. |
...
| spotfire-server.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-server.image.tag | string | `"14.7.0-v5.0.2"` | The container image tag to use. |
...
| spotfire-server.ingress.servicePort | int | `80` | The haproxy service port that the ingress will route traffic to. |
...
| spotfire-server.livenessProbe.httpGet.port | string | `"service"` |  |
...
| spotfire-server.startupProbe.httpGet.port | string | `"service"` |  |
...
| spotfire-terrservice.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-terrservice.image.tag | string | `"1.24.0-v5.0.2"` | The container image tag to use. |
...
| spotfire-webplayer.fluentBitSidecar.image.tag | string | `"4.1.0"` | The image tag to use for fluent-bit logging sidecar. |
...
| spotfire-webplayer.image.tag | string | `"14.7.0-HF-002-v5.0.2"` | The container image tag to use. |
