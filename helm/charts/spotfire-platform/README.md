...
![Version: 4.0.1](https://img.shields.io/badge/Version-4.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 14.8-v6.0.1](https://img.shields.io/badge/AppVersion-14.8--v6.0.1-informational?style=flat-square)
...
|------------|------|---------|
| file://../spotfire-automationservices/ | spotfire-automationservices | 4.0.1 |
| file://../spotfire-pythonservice/ | spotfire-pythonservice | 4.0.1 |
| file://../spotfire-rservice/ | spotfire-rservice | 4.0.1 |
| file://../spotfire-server/ | spotfire-server | 4.0.1 |
| file://../spotfire-terrservice/ | spotfire-terrservice | 4.0.1 |
| file://../spotfire-webplayer/ | spotfire-webplayer | 4.0.1 |
...
| spotfire-automationservices.image.tag | string | `"14.8.0-HF-001-v6.0.1"` | The container image tag to use. |
...
| spotfire-pythonservice.image.tag | string | `"1.25.0-v6.0.1"` | The container image tag to use. |
...
| spotfire-rservice.image.tag | string | `"1.25.0-v6.0.1"` | The container image tag to use. |
...
| spotfire-server.cliPod.image.tag | string | `"14.8.0-v6.0.1"` | The spotfireConfig container image tag to use. |
...
| spotfire-server.configJob.image.tag | string | `"14.8.0-v6.0.1"` | The spotfireConfig container image tag to use. |
...
| spotfire-server.configuration.deployment.defaultDeployment.image.tag | string | `"14.8.0-HF-001-v6.0.1"` | The container image tag to use. |
...
| spotfire-server.image.tag | string | `"14.8.0-v6.0.1"` | The container image tag to use. |
...
| spotfire-terrservice.image.tag | string | `"1.25.0-v6.0.1"` | The container image tag to use. |
...
| spotfire-webplayer.image.tag | string | `"14.8.0-HF-001-v6.0.1"` | The container image tag to use. |
